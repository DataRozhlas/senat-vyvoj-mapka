...
(function () {
  ...
  init = function () {
    ...
    x$.html("Po volbách 1. 10. 2022 (řádné)");
    ...
    y$.on("time", function (it) {
      ...
      heading.html(
        "Po volbách " +
          (lastVolby.date.toISOString().substring(0, 7) === "2022-10"
            ? "1"
            : lastVolby.date.getDate()) +
          ". " +
          (lastVolby.date.getMonth() + 1) +
          ". " +
          lastVolby.date.getFullYear() +
          " (" +
          radne +
          ")"
      );
